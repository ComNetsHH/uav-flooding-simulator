#ifndef RDF_ENVIRONMENT_H
#define RDF_ENVIRONMENT_H
...
class RdfEnvironment : public OpenGymEnv
{
public:
  RdfEnvironment ();
  RdfEnvironment (Time stepTime);
  virtual ~RdfEnvironment ();
